      ...
      <div className="mx-auto max-w-2xl px-6 py-12">
        ...
        <div className="space-y-4">
          ...
          <SettingsSection
            ...
            description="This extension is local-only — it has no direct Drive integration"
          >
            <p className="text-[13px] leading-relaxed text-ink-soft dark:text-white/70">
              To have exports land in Drive automatically: install{' '}
              <span className="font-medium text-ink dark:text-white">Google Drive for Desktop</span>, let it sync a
              local folder, then set that folder as Chrome's default download location under{' '}
              <span className="font-mono text-xs">chrome://settings/downloads</span>. Every export from this
              extension will then save straight into Drive.
            </p>
          </SettingsSection>
